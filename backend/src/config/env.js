...
const RAW_ALLOWED = process.env.CORS_ORIGIN
  ...
  : [
      ...
      "https://backend.rootsmaghreb.com", // Backend subdomain (for health checks, etc.)
...
// PASSENGER-SAFE: Never exit on missing env vars - log warning instead
if (!JWT_SECRET) {
  console.warn("⚠️ WARNING: Missing JWT_SECRET in backend/.env - authentication will fail");
