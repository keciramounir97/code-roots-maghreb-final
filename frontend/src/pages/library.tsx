...
export default function Library() {
  ...
  const latestBook = useMemo(() => sortByDateDesc(books)[0], [books]);
  const latestTree = useMemo(() => sortByDateDesc(trees)[0], [trees]);
  const latestImage = useMemo(() => sortByDateDesc(gallery)[0], [gallery]);
