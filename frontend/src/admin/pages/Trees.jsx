    ...
    <div className={`p-4 min-h-screen ${pageBg} ${text} heritage-page-root`}>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[380px_1fr] gap-6">
        <div className="space-y-6">
          ...
          >
            <div className={`text-lg font-bold mb-4 ${isDark ? 'text-[#f8f5ef]' : 'text-[#3e2723]'}`}>
              {selectedTree
            ...
            <div className="space-y-3">
              <div>
                <label className={`block text-sm font-semibold mb-1.5 ${isDark ? 'text-[#e8dfca]' : 'text-[#5d4037]'}`}>
                ...
                <input
                  ...
                  focus:outline-none focus:ring-2 focus:ring-[#5d4037]/25 focus:border-[#5d4037]/50 transition-all`}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className={`heritage-input w-full px-4 py-2.5 rounded-lg border ${border} ${inputBg} ${inputText}
                  focus:outline-none focus:ring-2 focus:ring-[#5d4037]/25 focus:border-[#5d4037]/50 transition-all resize-none`}
                />
              </div>
              ...
              ${isDark ? 'bg-white/5' : 'bg-[#f8f5ef]/50'} cursor-pointer transition-all hover:opacity-90`}>
                <input
                  ...
                  ${isDark ? 'accent-[#d4af37]' : 'accent-[#5d4037]'} cursor-pointer`}
                />
                <span className={`text-sm font-semibold ${isDark ? 'text-[#e8dfca]' : 'text-[#5d4037]'}`}>
                  {treeForm.isPublic
                    ? t("public", "Public")
                    : t("private", "Private")}
                </span>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2">
              <button
                ...
                ${isDark 
                  ? 'bg-[#5d4037] hover:bg-[#5d4037]/90 text-white' 
                  : 'bg-[#5d4037] hover:bg-[#5d4037]/90 text-white'
                }`}
              ...
              <button
                ...
                ${isDark 
                  ...
                  : 'bg-white hover:bg-[#f8f5ef] text-[#5d4037]'
                }`}
                onClick={clearCanvas}
          ...
          >
            <div className="grid grid-cols-2 gap-3 mb-4">
              <button
                ...
                className={`px-4 py-2.5 rounded-lg border text-sm font-semibold transition-all ${
                  tab === "my"
                    ? `${isDark ? 'bg-[#5d4037] text-white border-[#5d4037] shadow-md' : 'bg-[#5d4037] text-white border-[#5d4037] shadow-md'}`
                    : `${border} ${hoverRow} ${isDark ? 'text-[#e8dfca]' : 'text-[#5d4037]'}`
                }`}
                onClick={() => setTab("my")}
              >
                {t("my_trees", "My Trees")}
            ...
            <div className="relative mb-4">
              <Search className={`w-4 h-4 absolute rtl:right-3 rtl:left-auto ltr:left-3 top-1/2 -translate-y-1/2 ${isDark ? 'text-[#d4af37]/60' : 'text-[#5d4037]/60'}`} />

              <input
                value={q}
                onChange={(e) => setQ(e.target.value)}
                className={`heritage-input w-full rtl:pr-9 rtl:pl-3 ltr:pl-9 ltr:pr-3 py-2.5 rounded-lg border
                focus:outline-none focus:ring-2 focus:ring-[#5d4037]/25 focus:border-[#5d4037]/50
                ...
                {filteredTrees.map((tree) => {
                  ...
                  return (
                    <div
                      ...
                      focus:outline-none focus:ring-2 focus:ring-[#5d4037]/40 cursor-pointer
                      ${
                        active
                          ? `ring-2 ring-[#5d4037]/50 border-[#5d4037] ${isDark ? 'bg-[#5d4037]/20' : 'bg-[#5d4037]/10'} shadow-lg scale-[1.02]`
                          : `hover:shadow-lg hover:border-[#5d4037]/30 ${hoverRow}`
                      }`}
                    >
        ...
        >
          <div className="mb-4">
            <div className={`text-xl font-bold mb-1 ${isDark ? 'text-[#f8f5ef]' : 'text-[#3e2723]'}`}>
