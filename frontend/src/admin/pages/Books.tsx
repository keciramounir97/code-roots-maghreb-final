...
export default function Books() {
  ...
  const accentText = isDark ? "text-[#d4af37]" : "text-[#5d4037]";
                        ...
                        <td className="py-3 px-4 text-start">
                          <div className="flex items-center gap-3">
                            {coverSrc ? (
                              ...
                              <div
                                className={`h-12 w-9 rounded-md ${border} bg-gradient-to-br from-[#5d4037]/10 to-[#d4af37]/15 text-[#5d4037] text-xs font-bold flex items-center justify-center`}
                              >
                                {initial}
                              </div>
                            )}
              ...
              <div className="space-y-4">
                <div className={`rounded-xl border ${border} ${softPanel} p-4`}>
                  ...
                  <div className="mt-3 grid grid-cols-[96px_1fr] gap-3 items-center">
                    <div
                      className={`h-28 w-20 rounded-md border ${border} overflow-hidden bg-gradient-to-br from-[#5d4037]/10 to-[#d4af37]/15 flex items-center justify-center`}
                    >
                      {coverPreview ? (
                        <img
                          src={coverPreview}
